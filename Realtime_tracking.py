...
while(True):
    ...
    img_mask = cv.morphologyEx(img_mask,cv.MORPH_OPEN,kernel) # 모폴로지 연산으로 노이즈 제거
    ...
    numOfLabels, img_label,stats,centroids = cv.connectedComponentsWithStats(img_mask) # 라벨링
